...
<DIV class='title_line'><A href="./list_by_exertypeno_grid.do?exertypeno=${exertypeno }" class='title_link'>${exertypeVO.EXERCISE_TYPE_NAME }</A> > ${title } 삭제</DIV>
...
<DIV class='content_body'>
  <ASIDE class="aside_right">
    ...
    <span class='menu_divide' >│</span>
    <A href="./update.do?exerciseno=${exerciseno}">수정</A>
  </ASIDE> 
        ...
        <DIV style='text-align: center; width: 50%; float: left;'>
          ...
          <c:choose>
            <c:when test="${thumb1.endsWith('jpg') || thumb1.endsWith('png') || thumb1.endsWith('gif')}">
              <IMG src="/exercise/storage/${file1saved }" style='width: 90%;'> 
            </c:when>
