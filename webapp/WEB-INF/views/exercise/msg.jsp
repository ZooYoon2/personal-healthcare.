...
<c:set var="exertypeno" value="${param.exertypeno }" />
    ...
    <UL>
      <c:choose>
        ...
        <c:when test="${code == 'product_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>                                                   
            <button type='button' 
                         onclick="location.href='./product_update.do?exertypeno=${exertypeno}&exerciseno=${exerciseno }'"
      ...
      <LI class='li_none'>
        ...
        <button type="button" onclick="location. href='./create.do?exertypeno=${exertypeno }'" class="btn btn-primary">새로운 운동 등록</button>
