...
public class Tool {
  ...
  public static synchronized String unit(long size){
    ...
    if (size < 1024){ // 1 KB 이하, 1024 byte 미만이면
    ...
    }else if (size < 1024L * 1024 * 1024 * 1024){ // 1 TB 이하,  큰 정수 표현을 위해 int->long 형식으로 변환
      ...
      str = (int)(Math.ceil(size/1024.0/1024.0/1024.0/1024.0/1024.0/1024.0/1024.0)) + " ZB";//Google이 사용중인 단위
    }
